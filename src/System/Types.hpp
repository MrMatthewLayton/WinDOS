...
public:
    ...
    Boolean operator!() const { return !_value; }
    Boolean operator&&(const Boolean& other) const { return _value && other._value; }
    Boolean operator||(const Boolean& other) const { return _value || other._value; }
    // Overloads with primitive bool to avoid ambiguity
    Boolean operator&&(bool other) const { return _value && other; }
    Boolean operator||(bool other) const { return _value || other; }

    bool operator==(const Boolean& other) const { return _value == other._value; }
    bool operator!=(const Boolean& other) const { return _value != other._value; }
    // Overloads with primitive bool to avoid ambiguity
    bool operator==(bool other) const { return _value == other; }
    bool operator!=(bool other) const { return _value != other; }
    ...
    int GetHashCode() const { return _value ? 1 : 0; }
};
...
public:
    ...
    bool operator==(const Char& other) const { return _value == other._value; }
    bool operator!=(const Char& other) const { return _value != other._value; }
    bool operator<(const Char& other) const { return _value < other._value; }
    bool operator>(const Char& other) const { return _value > other._value; }
    bool operator<=(const Char& other) const { return _value <= other._value; }
    ...
    bool operator==(char other) const { return _value == other; }
    bool operator!=(char other) const { return _value != other; }
    bool operator<(char other) const { return _value < other; }
    bool operator>(char other) const { return _value > other; }
    bool operator<=(char other) const { return _value <= other; }
    ...
    static bool IsLetterOrDigit(char c) { return IsLetter(c) || IsDigit(c); }
    static bool IsWhiteSpace(char c) { return c == ' ' || c == '\t' || c == '\n' || c == '\r'; }
    static bool IsUpper(char c) { return c >= 'A' && c <= 'Z'; }
    static bool IsLower(char c) { return c >= 'a' && c <= 'z'; }
    static char ToUpper(char c) { return IsLower(c) ? (c - 32) : c; }
    static char ToLower(char c) { return IsUpper(c) ? (c + 32) : c; }

    String ToString() const;

    int GetHashCode() const { return static_cast<int>(_value); }
};
...
public: \
    ...
    \
    operator UnderlyingType() const { return _value; } \
    \
    ClassName operator+(const ClassName& other) const { return _value + other._value; } \
    ClassName operator-(const ClassName& other) const { return _value - other._value; } \
    ClassName operator*(const ClassName& other) const { return _value * other._value; } \
    ClassName operator/(const ClassName& other) const { \
        if (other._value == 0) throw InvalidOperationException("Division by zero."); \
    ...
    \
    ClassName operator-() const { return -_value; } \
    ClassName operator+() const { return +_value; } \
    \
    ClassName& operator++() { ++_value; return *this; } \
    ClassName operator++(int) { ClassName tmp(*this); ++_value; return tmp; } \
    ClassName& operator--() { --_value; return *this; } \
    ClassName operator--(int) { ClassName tmp(*this); --_value; return tmp; } \
    \
    ClassName& operator+=(const ClassName& other) { _value += other._value; return *this; } \
    ClassName& operator-=(const ClassName& other) { _value -= other._value; return *this; } \
    ClassName& operator*=(const ClassName& other) { _value *= other._value; return *this; } \
    ...
    ClassName operator^(const ClassName& other) const { return _value ^ other._value; } \
    ClassName operator~() const { return ~_value; } \
    ClassName operator<<(int shift) const { return _value << shift; } \
    ClassName operator>>(int shift) const { return _value >> shift; } \
    \
    ClassName& operator&=(const ClassName& other) { _value &= other._value; return *this; } \
    ClassName& operator|=(const ClassName& other) { _value |= other._value; return *this; } \
    ClassName& operator^=(const ClassName& other) { _value ^= other._value; return *this; } \
    ClassName& operator<<=(int shift) { _value <<= shift; return *this; } \
    ClassName& operator>>=(int shift) { _value >>= shift; return *this; } \
    \
    bool operator==(const ClassName& other) const { return _value == other._value; } \
    bool operator!=(const ClassName& other) const { return _value != other._value; } \
    bool operator<(const ClassName& other) const { return _value < other._value; } \
    bool operator>(const ClassName& other) const { return _value > other._value; } \
    bool operator<=(const ClassName& other) const { return _value <= other._value; } \
