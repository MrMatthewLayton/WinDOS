...
namespace System::IO::Devices
{
    ...
    public:
        ...
        MouseStatus() : x(0), y(0), leftButton(false), rightButton(false), middleButton(false)
        {
        }
        ...
        MouseStatus(const Int32 x, const Int32 y, const Boolean left, const Boolean right, const Boolean middle)
    ...
    public:
        ...
        ///
        /// @return True if a mouse driver is present and initialized successfully, false if no mouse driver is available.
        ...
        ///
        /// @note When using a custom software cursor (as in the Forms system), the hardware cursor should typically remain hidden.
        ...
        ///
        /// Queries the mouse driver for the current cursor position and the pressed state of all three mouse buttons.
        ///
        /// @return A MouseStatus structure containing the current x/y position and button states.
        ...
        /// on-screen distance.
        ///
        /// @param xMickeys Mickeys per 8 horizontal pixels. Default is 8.
        /// @param yMickeys Mickeys per 8 vertical pixels. Default is 16.
        ///
        ...
        ///       more natural.
        static void SetSensitivity(Int32 xMickeys, Int32 yMickeys);
        ...
        /// @return True if middle button is currently down
        static Boolean IsMiddleButtonPressed();
    };
} // namespace System::IO::Devices
